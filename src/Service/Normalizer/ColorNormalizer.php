...
{
    public const WITH_ALPHA = 'withAlpha';
    public const WITH_HASH = 'withHash';
    ...
    public function normalize(
        ...
        $withAlpha = $this->utils->get(self::WITH_ALPHA, $context, false);
        $withHash = $this->utils->get(self::WITH_HASH, $context, true);
